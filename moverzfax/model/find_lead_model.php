                ...
                <div class="container in-container slide-in-bottom shadow rounded" style="animation-delay: <?=$count*50; ?>ms;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="bottom-bar-left px-3 col-md-10 shadow-sm py-2">
                                        <?php if($res["usdot1"] == $usdot || $res["usdot2"] == $usdot || $res["usdot3"] == $usdot || $res["usdot4"] == $usdot || $res["usdot5"] == $usdot || $res["usdot6"] == $usdot || $res["usdot7"] == $usdot || $res["usdot8"] == $usdot){
                                            ...
                                            <a href="../model/lead_model.php?lead=generate&id=<?php echo $res['id'] ?>" class="btn custom-btn-2 bg-success shadow text-light"><span>Generate Lead</span></a></a>
                                        <?php } ?>
                                    </div>
