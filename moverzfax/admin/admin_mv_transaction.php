...
<div class="b-container">
    <div class="container-fluid in-container slide-in-bottom">
        <div class="row">
            <div class="col-12">
                <h4>Mover Transaction</h4>
                <div class="d-flex">
                    <label for="" class="form-label col-md-2 mt-2 p-0 pl-3">Search Transction :</label>
                    <input type="text" class="form-control col-md-3 mb-3" id="mv_search_transaction" placeholder="Search ID or Email" onkeyup="mover_transaction()">
                </div>
                    <div id="mv_search_transaction_table">
                        <table class="table table-striped">
                            ...
                            <tbody> 
                            <?php include 'admin_model/admin_mv_transaction_model.php'; ?>
                    </div>
