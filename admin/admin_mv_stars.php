    ...
    <div class="container-fluid in-container slide-in-bottom">
        <div class="row">
            <div class="col-12">
                <h4>All Movers</h4>
                <!-- <div class="d-flex">
                    <label for="" class="form-label col-md-2 mt-2 p-0 pl-3">Search Mover :</label>
                    <input type="text" class="form-control col-md-3 mb-3" id="mv_user_search" placeholder="Search Usdot or Name or Email" onkeyup="mover_user()">
                </div> -->
                    <div id="mv_user_search_table">
                        <table class="table table-striped">
                            <thead class="bg-dark">
                                ...
                                <th>Name</th>
                                <th>Email</th>
                                <th>Review Star Ratings</th>
                            </thead>
                        
                            <tbody> 
                            <?php include 'admin_model/admin_mv_stars_model.php'; ?>
                    </div>
