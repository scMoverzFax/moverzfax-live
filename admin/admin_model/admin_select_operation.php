                ...
                if(mysqli_num_rows($result1) > 0){
                    ...
                    $contact_person = $res['contact_person'];
                        ...
                        // echo $sql1; die();
                            ...
                            {
                                header('Location: ../admin_reports.php?usdot='.$usdot.'&status=as');//added sucessfully
                            }
                            else{ 
                                header('Location: ../admin_reports.php?usdot='.$usdot.'&status=rf');//request failed
                            }
                }
                else{
                    ...
                    if(mysqli_num_rows($result2) > 0){
                        ...
                        header('Location: ../admin_reports.php?usdot='.$usdot.'&status=nr');
                    }
                }
            } else {
                header('Location: ../admin_reports.php?usdot='.$usdot.'&status=ae');//already exists
            }
