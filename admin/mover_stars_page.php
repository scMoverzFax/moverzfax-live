    ...
    <div class="container-fluid in-container slide-in-bottom">
        <div class="row">
            <div class="col-12">
                ...
                <form action="admin_model/mover_rating_update_model.php" method="post" enctype="multipart/form-data">
                    <div id="mv_user_search_table">
                        <table class="table table-striped">
                            ...
                            <?php include 'admin_model/mover_stars_page_model.php'; ?>
                        </table>
                    </div>
                    <input style="display:none;" value="<?php echo $usdot ?>" name='usdot' type="text" class="form-control"/>
                    <button type="submit" class="btn btn-primary">Update This Mover's Ratings</button>
                </form>
                <br>
                    <a href="admin_mv_stars.php">
                        <button class="btn btn-secondary">Back to Table</button>
                    </a>
            </div>
        </div>
    </div>
