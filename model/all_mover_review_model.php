...
if ($con->connect_error) {
  ...
  $sql = "SELECT r.*,c.first_name,c.last_name,ci.name AS origin_city_name,cit.name AS destination_city_name,st.name,mr.contact_number FROM `review` AS r
          ...
          LEFT JOIN `state` AS st ON st.code = mr.states WHERE r.is_active = '0' AND admin_approval != 'pending'";
                ...
                <article class="blog-card mb-3">
                    <div class="blog-card__info">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <!-- <span class="icon-link p-0 float-right"><i class="far fa-calendar-alt me-2"></i>Review Date :<label><?php echo strtoupper($res['review_date']); ?></label></span> -->
                        </div>
                    </div>
                </article>
